...
<body class="bg-light">
                        ...
                        <form>
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="ps-0"> <label class="form-label">Site Title</label>
                                        <input type="text" id="site_title_inp" class="form-control shadow-none"
                                            name="site_title">
                                    </div>
                                    <div class="mb-3"> <label class="form-label">About us</label>
    ...
    <script>
        ...
        function upd_general(site_title_val, site_about_val) {
            ...
            xhr.send('site_title=' + site_site_title_val + '&site_about=' + site_site_about_val +& upd_general);
        }
