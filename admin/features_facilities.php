            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <div class="table-responsive-md overflow-scroll" style="height=350px; overflow-y:scroll;">
            ...
            <form id="facility_s_form">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3"> <label class="form-label fw-bold">Icon</label>
                            <input type="file" accept=".svg" class="form-control shadow-none" name="facility_icon">
